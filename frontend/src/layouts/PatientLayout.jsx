...
import { LayoutDashboard, CalendarDays, Star, Settings, HelpCircle, Bell, Menu, PanelLeftClose, PanelLeftOpen } from 'lucide-react'

const patientNavigation = [
    { title: 'Dashboard', path: '/patient/dashboard', icon: LayoutDashboard },
    { title: 'Appointments', path: '/patient/appointments', icon: CalendarDays },
    { title: 'My Reviews', path: '/patient/reviews', icon: Star },
    { title: 'Settings', path: '/patient/settings', icon: Settings },
    { title: 'Help Center', path: '/patient/help', icon: HelpCircle },
]
...
const PatientLayoutInner = () => {
    ...
    return (
        <div className="admin-layout-root">
            {/* Sidebar */}
            <Sidebar
                navigationItems={patientNavigation}
                user={{
                    name: user?.name || 'Patient',
                    email: user?.email || 'patient@medibook.com',
